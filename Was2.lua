    ...
    return function(aa)
        return {
            ...
            Midnight = {
                ...
                PlaceholderText = Color3.fromHex("#2f74d1"),
                WindowBackground = Color3.fromHex("#0a0f1e"),
                WindowShadow = Color3.fromHex("#000000"),
                WindowTopbarTitle = Color3.fromHex("#dbeafe"),
                WindowTopbarAuthor = Color3.fromHex("#3b82f6"),
                WindowTopbarIcon = Color3.fromHex("#3b82f6"),
                WindowTopbarButtonIcon = Color3.fromHex("#3b82f6"),
                TabBackground = Color3.fromHex("#2563eb"),
                TabTitle = Color3.fromHex("#dbeafe"),
                TabIcon = Color3.fromHex("#3b82f6"),
                ElementBackground = Color3.fromHex("#dbeafe"),
                ElementTitle = Color3.fromHex("#dbeafe"),
                ElementDesc = Color3.fromHex("#3b82f6"),
                ElementIcon = Color3.fromHex("#3b82f6"),
                PopupBackground = Color3.fromHex("#0a0f1e"),
                PopupBackgroundTransparency = 0,
                PopupTitle = Color3.fromHex("#dbeafe"),
                PopupContent = Color3.fromHex("#2f74d1"),
                PopupIcon = Color3.fromHex("#3b82f6"),
                DialogBackground = Color3.fromHex("#0a0f1e"),
                DialogBackgroundTransparency = 0,
                DialogTitle = Color3.fromHex("#dbeafe"),
                DialogContent = Color3.fromHex("#2f74d1"),
                DialogIcon = Color3.fromHex("#3b82f6"),
                Tooltip = Color3.fromHex("#2563eb"),
                TooltipText = Color3.fromHex("#dbeafe"),
                TooltipSecondary = Color3.fromHex("#1e3a8a"),
                TooltipSecondaryText = Color3.fromHex("#dbeafe"),
            },
            Crimson = {
                Name = "Crimson",
                ...
                Checkbox = Color3.fromHex("#dc2626"),
                PlaceholderText = Color3.fromHex("#6f757b"),
                WindowBackground = Color3.fromHex("#0c0404"),
                WindowShadow = Color3.fromHex("#000000"),
                WindowTopbarTitle = Color3.fromHex("#fef2f2"),
                WindowTopbarAuthor = Color3.fromHex("#dc2626"),
                WindowTopbarIcon = Color3.fromHex("#dc2626"),
                WindowTopbarButtonIcon = Color3.fromHex("#dc2626"),
                TabBackground = Color3.fromHex("#991b1b"),
                TabTitle = Color3.fromHex("#fef2f2"),
                TabIcon = Color3.fromHex("#dc2626"),
                ElementBackground = Color3.fromHex("#fef2f2"),
                ElementTitle = Color3.fromHex("#fef2f2"),
                ElementDesc = Color3.fromHex("#dc2626"),
                ElementIcon = Color3.fromHex("#dc2626"),
                PopupBackground = Color3.fromHex("#0c0404"),
                PopupBackgroundTransparency = 0,
                PopupTitle = Color3.fromHex("#fef2f2"),
                PopupContent = Color3.fromHex("#6f757b"),
                PopupIcon = Color3.fromHex("#dc2626"),
                DialogBackground = Color3.fromHex("#0c0404"),
                DialogBackgroundTransparency = 0,
                DialogTitle = Color3.fromHex("#fef2f2"),
                DialogContent = Color3.fromHex("#6f757b"),
                DialogIcon = Color3.fromHex("#dc2626"),
                Tooltip = Color3.fromHex("#991b1b"),
                TooltipText = Color3.fromHex("#fef2f2"),
                TooltipSecondary = Color3.fromHex("#b91c1c"),
                TooltipSecondaryText = Color3.fromHex("#fef2f2"),
            },
            MonokaiPro = {
                Name = "Monokai Pro",
                ...
                Slider = Color3.fromHex("#a9dc76"),
                Checkbox = Color3.fromHex("#a9dc76"),
                PlaceholderText = Color3.fromHex("#6f6f6f"),
                WindowBackground = Color3.fromHex("#191622"),
                WindowShadow = Color3.fromHex("#000000"),
                WindowTopbarTitle = Color3.fromHex("#fcfcfa"),
                WindowTopbarAuthor = Color3.fromHex("#a9dc76"),
                WindowTopbarIcon = Color3.fromHex("#a9dc76"),
                WindowTopbarButtonIcon = Color3.fromHex("#a9dc76"),
                TabBackground = Color3.fromHex("#ab9df2"),
                TabTitle = Color3.fromHex("#fcfcfa"),
                TabIcon = Color3.fromHex("#a9dc76"),
                ElementBackground = Color3.fromHex("#fcfcfa"),
                ElementTitle = Color3.fromHex("#fcfcfa"),
                ElementDesc = Color3.fromHex("#a9dc76"),
                ElementIcon = Color3.fromHex("#a9dc76"),
                PopupBackground = Color3.fromHex("#191622"),
                PopupBackgroundTransparency = 0,
                PopupTitle = Color3.fromHex("#fcfcfa"),
                PopupContent = Color3.fromHex("#6f6f6f"),
                PopupIcon = Color3.fromHex("#a9dc76"),
                DialogBackground = Color3.fromHex("#191622"),
                DialogBackgroundTransparency = 0,
                DialogTitle = Color3.fromHex("#fcfcfa"),
                DialogContent = Color3.fromHex("#6f6f6f"),
                DialogIcon = Color3.fromHex("#a9dc76"),
                Tooltip = Color3.fromHex("#ab9df2"),
                TooltipText = Color3.fromHex("#fcfcfa"),
                TooltipSecondary = Color3.fromHex("#fc9867"),
                TooltipSecondaryText = Color3.fromHex("#fcfcfa"),
            },
            CottonCandy = {
                Name = "Cotton Candy",
                ...
                Toggle = Color3.fromHex("#06b6d4"),
                Slider = Color3.fromHex("#06b6d4"),
                Checkbox = Color3.fromHex("#06b6d4"),
                PlaceholderText = Color3.fromHex("#8a5fd3"),
                WindowBackground = Color3.fromHex("#1a0b2e"),
                WindowShadow = Color3.fromHex("#000000"),
                WindowTopbarTitle = Color3.fromHex("#fdf2f8"),
                WindowTopbarAuthor = Color3.fromHex("#06b6d4"),
                WindowTopbarIcon = Color3.fromHex("#06b6d4"),
                WindowTopbarButtonIcon = Color3.fromHex("#06b6d4"),
                TabBackground = Color3.fromHex("#d946ef"),
                TabTitle = Color3.fromHex("#fdf2f8"),
                TabIcon = Color3.fromHex("#06b6d4"),
                ElementBackground = Color3.fromHex("#fdf2f8"),
                ElementTitle = Color3.fromHex("#fdf2f8"),
                ElementDesc = Color3.fromHex("#06b6d4"),
                ElementIcon = Color3.fromHex("#06b6d4"),
                PopupBackground = Color3.fromHex("#1a0b2e"),
                PopupBackgroundTransparency = 0,
                PopupTitle = Color3.fromHex("#fdf2f8"),
                PopupContent = Color3.fromHex("#8a5fd3"),
                PopupIcon = Color3.fromHex("#06b6d4"),
                DialogBackground = Color3.fromHex("#1a0b2e"),
                DialogBackgroundTransparency = 0,
                DialogTitle = Color3.fromHex("#fdf2f8"),
                DialogContent = Color3.fromHex("#8a5fd3"),
                DialogIcon = Color3.fromHex("#06b6d4"),
                Tooltip = Color3.fromHex("#d946ef"),
                TooltipText = Color3.fromHex("#fdf2f8"),
                TooltipSecondary = Color3.fromHex("#ec4899"),
                TooltipSecondaryText = Color3.fromHex("#fdf2f8"),
            },
Rainbow = {
    Name = "Rainbow",
    Accent = aa:Gradient({
...
local tabButton = Window.Creator.NewRoundFrame(Window.UICorner - 6, "Squircle", {
    Size = UDim2.new(0, 100, 0, 32),
    BackgroundTransparency = 1,
    Parent = am.TabBar,
    ThemeTag = { ImageColor3 = "TabBackground" },
}, {
    Window.Creator.NewRoundFrame(Window.UICorner - 6, "SquircleOutline", {
        Size = UDim2.new(1, 0, 1, 0),
        ThemeTag = { ImageColor3 = "Outline" },
        ImageTransparency = 1,
        Name = "Outline",
    }),
    Window.Creator.New("TextLabel", {
        Text = ap.Title,
        ThemeTag = { TextColor3 = "TabTitle" },
        TextSize = 15,
        FontFace = Font.new(Window.Creator.Font, Enum.FontWeight.Medium),
        AutomaticSize = "XY",
        Position = UDim2.new(0.5, 0, 0.5, 0),
        AnchorPoint = Vector2.new(0.5, 0.5),
    }),
...
ap.UIElements.Button = tabButton

local function rebuildContent()
    for _, child in ipairs(am.LeftPanel:GetChildren()) do
        if child:IsA("Frame") or child:IsA("ScrollingFrame") then
            child:Destroy()
        end
    end
    for _, child in ipairs(am.RightPanel:GetChildren()) do
        if child:IsA("Frame") or child:IsA("ScrollingFrame") then
            child:Destroy()
        end
    end
    if an.LeftBuilder then
        an.LeftBuilder(am.LeftPanel)
    end
    if an.RightBuilder then
        an.RightBuilder(am.RightPanel)
    end
end
...
tabButton.MouseEnter:Connect(function()
    if not ap.Locked then
        Window.Creator.Tween(tabButton, 0.08, { ImageTransparency = 0.93 }):Play()
    end
end)
tabButton.MouseLeave:Connect(function()
    if not ap.Locked then
        Window.Creator.Tween(tabButton, 0.08, { ImageTransparency = 1 }):Play()
    end
end)

am.Tabs[ap.Index] = ap

if not am.SelectedTab then
    am:SelectTab(ap.Index)
    rebuildContent()
end

function ap.ScrollToTheElement(ar,as)
    -- placeholder for compatibility
end

function ap.LockAll()
    for _,el in next,Window.AllElements do
        if el.Tab and el.Tab.Index and el.Tab.Index==ap.Index and el.Lock then
            el:Lock()
        end
    end
end
function ap.UnlockAll()
    for _,el in next,Window.AllElements do
        if el.Tab and el.Tab.Index and el.Tab.Index==ap.Index and el.Unlock then
            el:Unlock()
        end
    end
end
function ap.GetLocked()
    local locked={}
    for _,el in next,Window.AllElements do
        if el.Tab and el.Tab.Index and el.Tab.Index==ap.Index and el.Locked==true then
            table.insert(locked,el)
        end
    end
    return locked
end
function ap.GetUnlocked()
    local unlocked={}
    for _,el in next,Window.AllElements do
        if el.Tab and el.Tab.Index and el.Tab.Index==ap.Index and el.Locked==false then
            table.insert(unlocked,el)
        end
    end
    return unlocked
end
...
function am.SelectTab(idx)
am.SelectedTab=idx
for _,tab in pairs(am.Tabs) do
    local isActive = (tab.Index == idx)
    if tab.UIElements.Button then
        if isActive then
            tab.UIElements.Button.ImageTransparency = 0.93
            tab.UIElements.Button.Outline.ImageTransparency = 0.75
            if tab.UIElements.Button.TextLabel then
                tab.UIElements.Button.TextLabel.TextColor3 = Window.Creator.GetThemeProperty("Primary", Window.Theme)
            end
        else
            tab.UIElements.Button.ImageTransparency = 1
            tab.UIElements.Button.Outline.ImageTransparency = 1
            if tab.UIElements.Button.TextLabel then
                tab.UIElements.Button.TextLabel.TextColor3 = Window.Creator.GetThemeProperty("Text", Window.Theme)
            end
        end
    end
end
...
function am.OnChange(func)
am.OnChangeFunc=func
end
...
ak("UICorner",{ CornerRadius=UDim.new(1,0) }),
}),
ak("TextButton",{
...
if nameBtn then
    nameBtn.MouseButton1Click:Connect(function()
        as:OnPlayerNameClicked()
    end)
end

-- 选项卡管理器初始化
local tabBar = as.UIElements.Main.Main:FindFirstChild("TabBar")
local leftPanel = as.UIElements.Main.Main.ContentContainer:FindFirstChild("LeftPanel")
local rightPanel = as.UIElements.Main.Main.ContentContainer:FindFirstChild("RightPanel")
as.TabModule = a.load'U'
local u = as.TabModule.Init(as, ar.WindUI, tabBar, {LeftPanel=leftPanel, RightPanel=rightPanel})
...
function as.Tab(opt)
    ...
    return as.TabModule.New({
        Title = opt.Title,
        Icon = opt.Icon,
        LeftBuilder = opt.LeftBuilder,
        RightBuilder = opt.RightBuilder,
        Locked = opt.Locked,
    })
end

function as.SelectTab(idx)
    as.TabModule.SelectTab(idx)
end

function as.Section(parent, config)
    if not parent then
        warn("[WindUI] Section 需要传入父级容器（左栏或右栏）")
        return nil
    end
    config = config or {}
...
function as.Divider(parent)
    if not parent then
        warn("[WindUI] Divider 需要传入父级容器（左栏或右栏）")
        return nil
    end
    local line = ak("Frame", {
        Size = UDim2.new(1, 0, 0, 1),
...
function as.OpenUserInfoWindow()
    local win = as:Dialog({
        Title = "用户信息",
        Width = 360,
        Content = "",
        Buttons = {
            { Title = "关闭", Variant = "Secondary", Callback = function() end }
        }
    })
    local contentLabel = nil
    local function buildContent()
        local text = string.format(
            "<font color='#C084FC'>玩家名称</font>: %s\n" ..
            "<font color='#A78BFA'>等级</font>: %d\n" ..
            "<font color='#F472B6'>VIP状态</font>: %s\n" ..
            "<font color='#60A5FA'>经验值</font>: %d\n",
            as.userData.name,
            as.userData.level,
            as.userData.vip and "<font color='#4ADE80'>是</font>" or "<font color='#F87171'>否</font>",
            as.userData.exp
        )
        for k, v in pairs(as.userData.customFields) do
            text = text .. string.format("<font color='#94A3B8'>%s</font>: %s\n", k, tostring(v))
        end
        return text
    end
    task.spawn(function()
        task.wait(0.1)
        local dialogFrame = win.UIElements and win.UIElements.Main or win.Frame
        if dialogFrame then
            local contentContainer = dialogFrame:FindFirstChild("ContentContainer")
            if not contentContainer then
                ...
                local oldLayout = dialogFrame:FindFirstChildOfClass("UIListLayout")
                ...
                contentLabel.Text = buildContent()
            else
                contentLabel = contentContainer:FindFirstChildOfClass("TextLabel")
    ...
    win.RefreshUserInfo = function(newData)
...
function as.OnPlayerNameClicked()
    as:OpenUserInfoWindow()
end
...
function as.Open()
    task.spawn(function()
        ...
        task.spawn(function()
            ...
            if player then
                as.userData.name = player.DisplayName
                as.userData.level = player:GetAttribute("Level") or 1
                as.userData.vip = player:GetAttribute("VIP") or false
                as.userData.exp = player:GetAttribute("Exp") or 0
                local nameBtn = as.UIElements.Main.Main.PlayerBar:FindFirstChild("Name")
                if nameBtn then
                    nameBtn.Text = player.DisplayName
                end
                local avatar = as.UIElements.Main.Main.PlayerBar:FindFirstChild("Avatar")
                if avatar then
                    local content, isReady = player:GetUserThumbnailAsync(Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size100x100)
                    if isReady then
                        avatar.Image = content
                    end
                end
            end
            local ann = as.UIElements.Main.Main.PlayerBar:FindFirstChild("Announcement")
            if ann then
                ann.Text = "欢迎使用 WindUI"
            end
        end)
    end)
end
...
function as.Dialog(x,B)
    ...
    local F = a.load'l'.Init(as,nil)
    local G = F.Create(false)
    G.UIElements.Main.Size=UDim2.new(0,C.Width,0,0)
    local H=ak("Frame",{
        Size=UDim2.new(1,0,0,0),
        AutomaticSize="Y",
        BackgroundTransparency=1,
    ...
    G.UIElements.Title=ak("TextLabel",{
        ...
        TextWrapped=true,
        RichText=true,
        Size=UDim2.new(1,I and-26-12 or 0,0,0),
        AutomaticSize="Y",
        ThemeTag={ TextColor3="Text" },
        BackgroundTransparency=1,
        Parent=H
    ...
    for N,O in next,C.Buttons do
        local P=an(O.Title,O.Icon,O.Callback,O.Variant,L,G,false)
        table.insert(M,P)
    end
